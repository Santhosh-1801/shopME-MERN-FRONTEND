...
const Invoice = () => {
  ...
  return (
    <div>
    <MetaData title={"Invoice Details"}/>
    <div className="order-invoice my-5">
      ...
      <div id="order_invoice" className="p-3 border border-secondary">
        <header className="clearfix">
          <div id="logo">
            <img src="/images/shopme_logo.png" alt="Company Logo" />
          </div>
          <h1>INVOICE # {order._id}</h1>
          <div id="company" className="clearfix">
            <div>ShopMe</div>
            <div>
              11/13,Sheshadri Complex
              <br />
              Bangalore, Karnataka
            </div>
            <div>(602) 519-0450</div>
            <div>
              <a href="mailto:info@shopit.com">info@shopmestore.com</a>
            </div>
          </div>
          <div id="project">
