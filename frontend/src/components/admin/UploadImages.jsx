...
import { useDeleteProductImageMutation, useGetProductDetailsQuery, useUpdateProductImagesMutation } from '../../redux/api/productApi'
...
const UploadImages = () => {
  ...
  const [updateProductImages,{isLoading,error,isSuccess}]=useUpdateProductImagesMutation()
